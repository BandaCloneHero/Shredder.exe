...
namespace YARG.Gameplay.Player
{
    public class DrumsPlayer : TrackPlayer<DrumsEngine, DrumNote>
    {
        ...
        protected override int GetLedColorIndex(DrumNote note)
        {
            if (_fiveLaneMode)
            {
                return note.Pad switch
                {
                    (int)FiveLaneDrumPad.Green => 0,
                    (int)FiveLaneDrumPad.Red => 1,
                    (int)FiveLaneDrumPad.Yellow => 2,
                    (int)FiveLaneDrumPad.Blue => 3,
                    (int)FiveLaneDrumPad.Orange => 4,
                    _ => -1
                };
            }
            ...
            return note.Pad switch
            {
                (int)FourLaneDrumPad.GreenDrum or (int)FourLaneDrumPad.GreenCymbal => 0,
                (int)FourLaneDrumPad.RedDrum => 1,
                (int)FourLaneDrumPad.YellowDrum or (int)FourLaneDrumPad.YellowCymbal => 2,
                (int)FourLaneDrumPad.BlueDrum or (int)FourLaneDrumPad.BlueCymbal => 3,
                _ => -1
            };
        }
